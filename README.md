...
expect_warning(
  xpectr::strip_msg(suppressMessages(fn())),
...
expect_warning(
  ...
  fixed = TRUE)
expect_message(
  xpectr::strip_msg(suppressWarnings(fn())),
...
expect_message(
  ...
  fixed = TRUE)
# Assigning output
output_10073 <- xpectr::suppress_mw(fn())
# Testing class
expect_equal(
  class(output_10073),
  "character",
...
# Testing sum of element lengths
expect_equal(
  sum(xpectr::element_lengths(output_14357)),
  1L)
...
# Testing side effects
expect_warning(
  xpectr::strip_msg(suppressMessages(fn(x = 2, y = -1, z = 5))),
  xpectr::strip("'y'<0"),
  fixed = TRUE)
# Assigning output
output_10374 <- xpectr::suppress_mw(fn(x = 2, y = -1, z = 5))
# Testing class
expect_equal(
  class(output_10374),
  "numeric",
...
# Testing sum of element lengths
expect_equal(
  sum(xpectr::element_lengths(output_10374)),
  1L)
...
# Testing side effects
expect_message(
  xpectr::strip_msg(suppressWarnings(fn(x = 2, y = 0, z = 10))),
  xpectr::strip("'z' was 10!\n"),
  fixed = TRUE)
# Assigning output
output_19734 <- xpectr::suppress_mw(fn(x = 2, y = 0, z = 10))
# Testing class
expect_equal(
  class(output_19734),
  "numeric",
...
# Testing sum of element lengths
expect_equal(
  sum(xpectr::element_lengths(output_19734)),
  1L)
