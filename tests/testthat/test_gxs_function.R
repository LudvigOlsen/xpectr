...
test_that("gxs_function() works", {
  ...
  expected_tests2 <- c(
    ...
    "# Assigning output",
    "output_12654 <- fn(a = 5, a_fn = mean, b = c(\"ahhh\", \"ohhh\"), d = NULL, e = 3, f = \"hii\")",
    "# Testing class",
    "expect_equal(\n  class(output_12654),\n  \"list\",\n  fixed = TRUE)",
    "# Testing type",
    "expect_type(\n  output_12654,\n  type = \"list\")",
    ...
    "# Changed from baseline: e",
    "# Assigning output",
    "output_12016 <- fn(a = 5, a_fn = mean, b = c(\"ahhh\", \"ohhh\"), d = NULL, e = NULL, f = \"hii\")",
    "# Testing class",
    "expect_equal(\n  class(output_12016),\n  \"list\",\n  fixed = TRUE)",
    "# Testing type",
    "expect_type(\n  output_12016,\n  type = \"list\")",
    ...
    "# Assigning output",
    "output_18982 <- fn(a = 5, a_fn = mean, b = c(\"ahhh\", \"ohhh\"), d = NULL, e = 3, f = \"lol\")",
    "# Testing class",
    "expect_equal(\n  class(output_18982),\n  \"list\",\n  fixed = TRUE)",
    "# Testing type",
    "expect_type(\n  output_18982,\n  type = \"list\")",
  ...
  fn2_expected_tests <- c(
    ...
    "# Testing side effects",
    "expect_warning(\n  xpectr::strip_msg(suppressMessages(fn2(x = 2, y = -1, z = 5))),\n  xpectr::strip(\"'y'<0\"),\n  fixed = TRUE)",
    "# Assigning output",
    "output_13720 <- xpectr::suppress_mw(fn2(x = 2, y = -1, z = 5))",
    "# Testing class",
    "expect_equal(\n  class(output_13720),\n  \"numeric\",\n  fixed = TRUE)",
    "# Testing type",
    "expect_type(\n  output_13720,\n  type = \"double\")",
    ...
    "# Testing side effects",
    "expect_message(\n  xpectr::strip_msg(suppressWarnings(fn2(x = 2, y = 0, z = 10))),\n  xpectr::strip(\"'z' was 10!\\n\"),\n  fixed = TRUE)",
    "# Assigning output",
    "output_15727 <- xpectr::suppress_mw(fn2(x = 2, y = 0, z = 10))",
    "# Testing class",
    "expect_equal(\n  class(output_15727),\n  \"numeric\",\n  fixed = TRUE)",
    "# Testing type",
    "expect_type(\n  output_15727,\n  type = \"double\")",
