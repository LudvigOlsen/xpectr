...
test_that("gxs_function() works", {
  ...
  expected_tests2 <- c(
    ...
    "# Testing fn(a = 5, a_fn = mean, b = c(\"ahhh\", \"ohhh\"), ...",
    "# Testing class",
    "expect_equal(\n  class(fn(a = 5, a_fn = mean, b = c(\"ahhh\", \"ohhh\"), d = NULL, e = 3, f = \"lol\")),\n  \"list\",\n  fixed = TRUE)",
    "# Testing type",
    ...
    "expect_equal(\n  sum(xpectr::element_lengths(fn(a = 5, a_fn = mean, b = c(\"ahhh\", \"ohhh\"), d = NULL, e = 3, f = \"lol\"))),\n  2L)",
    "",
    "# Testing fn(a = 5, a_fn = mean, b = c(\"ahhh\", \"ohhh\"), ...",
    "# Testing side effects",
    ...
    "# Testing class",
    "expect_equal(\n  class(fn(a = 5, a_fn = sum, b = c(\"ahhh\", \"ohhh\"), d = NULL, e = 3, f = \"hii\")),\n  \"list\",\n  fixed = TRUE)",
    "# Testing type",
    ...
    "# Testing sum of element lengths",
    "expect_equal(\n  sum(xpectr::element_lengths(fn(a = 5, a_fn = sum, b = c(\"ahhh\", \"ohhh\"), d = NULL, e = 3, f = \"hii\"))),\n  2L)",
    "",
    "# Testing fn(a = 5, a_fn = mean, b = c(\"ehhh\", \"loool\"),...",
    "# Testing class",
    "expect_equal(\n  class(fn(a = 5, a_fn = mean, b = c(\"ehhh\", \"loool\"), d = NULL, e = 3, f = \"hii\")),\n  \"list\",\n  fixed = TRUE)",
    "# Testing type",
    ...
    "# Testing sum of element lengths",
    "expect_equal(\n  sum(xpectr::element_lengths(fn(a = 5, a_fn = mean, b = c(\"ehhh\", \"loool\"), d = NULL, e = 3, f = \"hii\"))),\n  2L)",
    "",
    ...
    "# Testing fn(a = 5, a_fn = mean, b = c(\"ahhh\", \"ohhh\"), ...",
    "# Testing class",
    "expect_equal(\n  class(fn(a = 5, a_fn = mean, b = c(\"ahhh\", \"ohhh\"), d = NULL, e = 6, f = \"hii\")),\n  \"list\",\n  fixed = TRUE)",
    "# Testing type",
    ...
    "# Testing sum of element lengths",
    "expect_equal(\n  sum(xpectr::element_lengths(fn(a = 5, a_fn = mean, b = c(\"ahhh\", \"ohhh\"), d = NULL, e = 6, f = \"hii\"))),\n  2L)",
    "",
    ...
    "# Testing fn(a = 5, a_fn = mean, b = c(\"ahhh\", \"ohhh\"), ...",
    "# Testing class",
    "expect_equal(\n  class(fn(a = 5, a_fn = mean, b = c(\"ahhh\", \"ohhh\"), d = NULL, e = 3, f = \"hii\")),\n  \"list\",\n  fixed = TRUE)",
    "# Testing type",
    ...
    "# Testing sum of element lengths",
    "expect_equal(\n  sum(xpectr::element_lengths(fn(a = 5, a_fn = mean, b = c(\"ahhh\", \"ohhh\"), d = NULL, e = 3, f = \"hii\"))),\n  2L)",
    "",
    "# Testing fn(a = 5, a_fn = mean, b = c(\"ahhh\", \"ohhh\"), ...",
    "# Testing class",
    "expect_equal(\n  class(fn(a = 5, a_fn = mean, b = c(\"ahhh\", \"ohhh\"), d = NULL, e = NULL, f = \"hii\")),\n  \"list\",\n  fixed = TRUE)",
    "# Testing type",
    ...
    "# Testing sum of element lengths",
    "expect_equal(\n  sum(xpectr::element_lengths(fn(a = 5, a_fn = mean, b = c(\"ahhh\", \"ohhh\"), d = NULL, e = NULL, f = \"hii\"))),\n  2L)",
    "",
    "# Testing fn(a = 5, a_fn = mean, b = c(\"ahhh\", \"ohhh\"), ...",
    "# Testing side effects",
  ...
  fn2_expected_tests <- c(
    ...
    "# Testing sum of element lengths",
    "expect_equal(\n  sum(xpectr::element_lengths(fn2(x = 2, y = 0, z = 15))),\n  1L)",
    "",
    "# Testing fn2(x = 2, y = 0, z = 5)",
    "# Testing class",
    "expect_equal(\n  class(fn2(x = 2, y = 0, z = 5)),\n  \"numeric\",\n  fixed = TRUE)",
    "# Testing type",
    "expect_type(\n  fn2(x = 2, y = 0, z = 5),\n  type = \"double\")",
    "# Testing values",
    "expect_equal(\n  fn2(x = 2, y = 0, z = 5),\n  7,\n  tolerance = 1e-4)",
    ...
    "# Testing sum of element lengths",
    "expect_equal(\n  sum(xpectr::element_lengths(fn2(x = 2, y = 0, z = 5))),\n  1L)",
    "",
