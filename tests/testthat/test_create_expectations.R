...
test_that("expectation are created properly with create_expectations_vector()", {
  ...
  exp_vec_3 <- list(
    paste0("## Testing 'vec_3'                                         ",
           "                 ####\n## Initially generated by xpectr"),
    "# Testing values",
    paste0("expect_equal(\n  vec_3,\n  c(a1 = 10, a2 = 2, a3 = 4, b1 = ",
           "20, b2 = 1, b3 = 3, c1 = 2, c2 = 3, c3 = 30),\n  tolerance =",
           " 1e-4)"),
    "# Testing names",
    paste0("expect_equal(\n  names(vec_3),\n  c(\"a1\", \"a2\", \"a3",
           "\", \"b1\", \"b2\", \"b3\", \"c1\", \"c2\", \"c3\"),\n  fixed",
  ...
  # vec_4
  exp_vec_4 <- list(
    paste0("## Testing 'vec_4'                                         ",
           "                 ####\n## Initially generated by xpectr"),
    "# Testing values",
    paste0("expect_equal(\n  vec_4,\n  list(a1 = 10, a2 = 2, a3 = 4, b1",
           " = 20, b2 = 1, b3 = 3, c1 = 2,     c2 = 3, c3 = 30))"),
    "# Testing names",
    paste0("expect_equal(\n  names(vec_4),\n  c(\"a1\", \"a2\", \"a3",
           "\", \"b1\", \"b2\", \"b3\", \"c1\", \"c2\", \"c3\"),\n  fixed",
...
test_that("expectations are created returned by insertExpectationsAddin()", {
  ...
  expect_equal(
    ...
    list(
      ...
      "# Testing names",
      "expect_equal(\n  names(xpectr::smpl(long_df$a, n = 30)),\n  NULL,\n  fixed = TRUE)",
      "# Testing length",
      "expect_equal(\n  length(long_df$a),\n  40L)",
      "# Testing sum of element lengths",
      "expect_equal(\n  sum(unlist(lapply(long_df$a, length))),\n  40L)",
      "## Finished testing 'long_df$a'                                             ####"
    ),
    fixed = TRUE)
