...
test_that("expectations are created returned by insertExpectationsAddin()", {
  ...
  expect_equal(
    gxs_selection("long_df$a", out = "return", strip = FALSE),
    list(paste0("expect_equal(\n  xpectr::smpl(long_df$a, n = 30),\n  c(0.93",
                "7075413297862, 0.286139534786344, 0.641745518893003, 0.51909",
                "5949130133, 0.736588314641267, 0.13466659723781, 0.705064784",
                "036949, 0.45774177624844, 0.719112251652405, 0.9346722471527",
                "76, 0.255428824340925, 0.978226428385824, 0.117487361654639,",
                " 0.474997081561014, 0.904031387297437, 0.138710167724639, 0.",
                "988891728920862, 0.946668232558295, 0.0824375580996275, 0.51",
