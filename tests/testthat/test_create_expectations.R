  ...
  expect_equal(
    ...
    list(
      ...
      paste0("expect_equal(\n  xpectr::smpl(long_df[[\"a\"]], n = 30),\n ",
             ...
             "506,\n0.45774, 0.71911, 0.93467, 0.25543, 0.97823, 0.11749, ",
             "0.475,\n0.90403, 0.13871, 0.98889, 0.94667, 0.08244, 0.51421",
             ", 0.3902,\n0.44697, 0.836, 0.7376, 0.81106, 0.00395, 0.83292",
             ", 0.00733,\n0.20766, 0.61178),\n  tolerance = 1e-4)"),
      paste0("expect_equal(\n  xpectr::smpl(long_df[[\"b\"]], n = 30),\n ",
             " c(0.43577, 0.03743, 0.43175, 0.95758, 0.88775, 0.63998, 0.6",
             "1884,\n0.33343, 0.34675, 0.39849, 0.78469, 0.67728, 0.17126,",
             " 0.26109,\n0.67561, 0.98282, 0.75954, 0.56649, 0.84969, 0.18",
             "947, 0.27129,\n0.6932, 0.24054, 0.04299, 0.14048, 0.19741, 0",
             ".71936, 0.00788,\n0.37549, 0.00157),\n  tolerance = 1e-4)"),
      "# Testing column names",
      "expect_equal(\n  names(long_df),\n  c(\"a\", \"b\"),\n  fixed = TRUE)",
      "# Testing column classes",
